...
Contains shared backend utilities and reusable infrastructure used across modules.
...
Contains configuration logic for environment variables and application settings.
...
Contains Prisma-related infrastructure.

Examples may include:

- Prisma service
- Database provider
- Prisma lifecycle handling
- Database connection logic

This keeps database access centralized and reusable across all backend modules.

---

### `src/modules/`

Contains the main domain modules of the backend.
...
Contains source-level testing utilities, mocks, helpers, or module-focused test support files.

---

### `test/`

Contains end-to-end tests and external testing setup for the NestJS application.
...
The Prisma layer is responsible for:

- Database schema modeling
- Database migrations
- Type-safe database queries
- Seeding demo data
- Maintaining relations between users, clients, agreements, milestones, payments, deliveries, timeline events, and AI review records

The `prisma/` directory may include:

```text
prisma/
├── schema.prisma       # Prisma data models and relations
├── migrations/         # Database migrations
└── seed.ts             # Demo or development seed data
```
...
# Client Portal
PORTAL_TOKEN_SECRET="YOUR_PORTAL_TOKEN_SECRET"
...
EMAIL_FROM="Dhaman <no-reply@your-domain.com>"

# Swagger
SWAGGER_ENABLED=true
```

Environment variable names may differ depending on the final implementation. Check the actual `.env.example`, config files, or deployment settings before running in production.
